...
<div class="card_container">
            <div class="card_descr">
                ...
                <div class="card_text"><?=$item->introtext;?></div>
                <div class="card_title">Что входит в стоимость?</div>
                <ul class="dbl-border">
                    <?foreach ($item->jcfields as $field) :?>
                        <?if (strpos($field->title, "desc") === 0) :?>
                            <li><a href="#"><?=$field->value?></a></li>
                        <?endif;?>
                    <?endforeach;?>
                  </ul>
            </div>
            <div class="card_photo">
                <div class="card_image"><img src="<?=json_decode($item->images)->image_intro?>" alt=""></div>
            </div>
        </div>
